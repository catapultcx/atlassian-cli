...
def main():
    ...
    p.add_argument('--labels', nargs='*', default=None, help='Replace all labels')
    p.add_argument('--add-labels', nargs='+', help='Add labels (keeps existing)')
    p.add_argument('--remove-labels', nargs='+', help='Remove labels')
    p.add_argument('--assignee', help='Assignee account ID')
